...
The knowledge graph exports to W3C vocabularies via CUE comprehensions. These projections make your knowledge graph interoperable with linked data tools without replacing CUE as the source of truth.
